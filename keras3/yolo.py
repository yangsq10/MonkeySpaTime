...
class YOLO(object):
    ...
    def detect_image(self, image, show_stats=True):
        ...
        if show_stats:
            print("Found {} monkeys for {}".format(len(out_boxes), "img"))
        if len(out_boxes)>5:
            import smtplib,ssl
            ...
            plain_text = """\
            Hi there,
            thanks for subscribing the Snow monkey checker.
            It is a good time to look at the snow monkeys now.
            You can visit the snow monkey park live web camera at here https://en.jigokudani-yaenkoen.co.jp/livecam2/video_en.php
            Enjoy your scene!
            """
